...
const AddEmployee = () => {
    ...
    const tabConfig = [
        ...
        { name: "Training & Development", path: "training-development", component: null },
        { name: "Off Borading", path: "off-borading", component: null },
        { name: "Activity Log", path: "activity-log", component: null }
    ];
    ...
    return (
        <div className="mx-5 mt-5 font-sans">
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden min-h-[calc(100vh-200px)]">
                ...
                {/* Breadcrumb */}
                <div className="flex items-center text-sm text-gray-500 my-3 mx-4">
