...
const SuccessModal = ({ isOpen, onClose, message = "Department Updated Successfully", subMessage = "Department is now updated." }) => {
    useEffect(() => {
        if (isOpen) {
            ...
            <div className="bg-white rounded-2xl p-8 w-[90%] max-w-[550px] shadow-2xl relative">
                ...
                <div className="flex items-center gap-5">
                    <div className="shrink-0">
                        <img src="/images/sucess_check.svg" alt="Success" className="w-[60px] h-[60px]" />
                    </div>
