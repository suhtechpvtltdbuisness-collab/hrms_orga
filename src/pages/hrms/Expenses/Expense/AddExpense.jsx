    ...
    <div className="bg-white px-4 sm:px-4 md:px-6 py-6 mx-2 sm:mx-4 mt-4 mb-4 rounded-xl h-[calc(100vh-10rem)] flex flex-col font-inter">
      ...
      <div className="flex-1 overflow-y-auto pr-2 pb-4">
        <div className="border border-[#E0E0E0] rounded-xl p-4 mb-4">
          <h3
            className="text-[16px] font-semibold text-[#1E1E1E] mb-4"
            style={{ fontFamily: "Nunito Sans, sans-serif" }}
          >
            Expense Details
          </h3>
          ...
          >
            ...
            <div>
              ...
              <FilterDropdown
                options={["Company Paid", "Self Paid"]}
                value={expenseData.paymentType}
                onChange={(val) =>
                  setExpenseData({ ...expenseData, paymentType: val })
                }
          ...
          <div>
            ...
            <textarea
              className={`w-full border border-[#D9D9D9] rounded-lg px-4 py-3 text-[16px] text-[#1E1E1E] focus:outline-none focus:border-[#7D1EDB] placeholder-[#757575] min-h-25 resize-none ${!isEditing ? "bg-gray-50" : ""}`}
          ...
          {isEditing ? (
            ...
            expenseData.bill ? (
              ...
              >
                ...
                />
                <span
                  className="text-[16px] font-medium text-[#1E1E1E] mb-1"
                  style={{ fontFamily: "Nunito Sans, sans-serif" }}
                >
                  Upload Bill
                </span>
