...
const ExpenseCategory = () => {
  ...
  return (
    <div
      className="bg-white px-4 sm:px-6 md:px-6 py-6 mx-2 sm:mx-4 mt-4 mb-4 rounded-xl h-[calc(100vh-10rem)] flex flex-col font-sans border border-[#D9D9D9]"
              ...
              >
                {categories.map((category) => (
                  ...
                  >
                    ...
                    <td className="py-2 px-4 text-[14px] font-semibold text-[#000000]">
                      {category.linkedAccount}
                    </td>
                    <td className="py-2 px-4 text-[14px] font-semibold text-[#000000]">
                      {formatCurrency(category.monthlyBudget)}
                    </td>
                    <td className="py-2 px-4 text-[14px] font-semibold text-[#000000]">
                      {formatCurrency(category.dailyLimit)}
                    </td>
