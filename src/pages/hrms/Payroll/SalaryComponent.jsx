            ...
            <div className="flex-1 w-full max-w-full overflow-y-auto pr-2 font-inter">
                ...
                <div className="border border-[#D6D6D6] rounded-lg p-4 mb-3">
                    ...
                    <div className="w-full lg:w-[66%] grid grid-cols-1 md:grid-cols-2 gap-3 mb-3"style={{ fontFamily: '"Inter", sans-serif' }}>
                        {/* Component Name */}
                        <div>
                            <label className="block text-[16px] font-normal text-[#1E1E1E] mb-1">Component Name</label>
                            <input 
                                type="text"
                                name="componentName"    
                        ...
                        <div>
                            ...
                            <FilterDropdown
                                ...
                                className="w-full h-[42px] px-3 bg-white border border-[#E0E0E0] rounded-lg text-[16px] font-normal text-[#1E1E1E] focus:ring-1 focus:ring-[#7D1EDB] flex items-center justify-between"
                                showArrow={true}
                                dropdownWidth="100%"
                                align='left'
                    ...
                    {/* Description */}
                    <div className="">
                        <label className="block text-[16px] font-normal text-[#1E1E1E] mb-1">Description</label>
                        <textarea 
                            name="description"
                            value={formData.description}
                            onChange={handleChange}
                            placeholder="Enter description"
                            className="w-full h-24 border border-[#E0E0E0] rounded-lg px-3 py-2 text-[16px] font-normal text-[#1E1E1E] focus:outline-none focus:border-[#7D1EDB] resize-none"
                        />
                    </div>
                </div>
                ...
                <div className="border border-[#D6D6D6] rounded-lg p-4 mb-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-3"style={{ fontFamily: '"Inter", sans-serif' }}>
                        {/* Amount */}
                        <div>
                        ...
                        {/* Formula */}
                        <div>
                            <label className="block text-[16px] font-normal text-[#1E1E1E] mb-1">Formula</label>
                            <input 
                                type="text"
                                name="formula"
                        ...
                        <div>
                            <label className="block text-[16px] font-normal text-[#1E1E1E] mb-1">Depends On Payment days</label>
                            <FilterDropdown
                    ...
                    <div className="w-full lg:w-[66%] grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center justify-between max-w-md">
                            <span className="text-[16px] font-normal text-[#1E1E1E]">Is Tax Applicable</span>
                        ...
                        <div className="flex items-center justify-between max-w-md">
                            <span className="text-[16px] font-normal text-[#1E1E1E]">Fixable Benefit</span>
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input 
                                    type="checkbox" 
                                    name="fixableBenefit"
                ...
                <div className="border border-[#D6D6D6] rounded-lg p-4">
                    ...
                    <div className="w-full lg:w-[66%] grid grid-cols-1 md:grid-cols-2 gap-3 mb-3"style={{ fontFamily: '"Inter", sans-serif' }}>
                        {/* Default Account */}
                        <div>
                            <label className="block text-[16px] font-normal text-[#1E1E1E] mb-1">Default Account</label>
                            <FilterDropdown
                    ...
                    <div>
                        <div className="mb-1">
                             <label className="block text-[16px] font-normal text-[#1E1E1E]">Status</label>
                        </div>
                        <div className="w-full md:w-[50%] lg:w-[33%] flex items-center justify-between max-w-sm">
                             <span className="text-[16px] font-normal  text-[#1E1E1E]">Disabled</span>
                             <label className="relative inline-flex items-center cursor-pointer">
                                <input 
                                    type="checkbox" 
                                    name="status"
