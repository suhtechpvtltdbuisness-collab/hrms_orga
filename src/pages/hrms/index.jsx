...
const HRMS = () => {
  ...
  const shortcutGroups = [
    ...
    },
    {
      ...
      icon: "/images/report.svg",
      items: [
        { name: "Holiday List", path: "/hrms/holiday-list" },
        { name: "Leave Period", path: "/hrms/leave-period" },
        { name: "Leave Block List", path: "/hrms/leave-block-list" },
        { name: "Compensatory Leave Request", path: "/hrms/compensatory-leave" },
        { name: "Leave Type", path: "/hrms/leave-type" },
        { name: "Leave Policy Assignment", path: "/hrms/leave-policy-assignment" },
        { name: "Leave Application", path: "/hrms/leave-application" },
        { name: "Leave Allocation", path: "/hrms/leave-allocation" },
        { name: "Leave Encashment", path: "/hrms/leave-encashment" },
        { name: "Leave Policy", path: "/hrms/leave-policy" },
      ],
    },
    {
      title: "Payroll",
      ...
      items: [
        ...
        {
          name: "Bank Integration For Salary Payout",
          path: "/hrms/bank-integration",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Pending Approvals", path: "/hrms/expenses/pending-approvals" },
        { name: "Expense Claims", path: "/hrms/" },
        { name: "Reimbursement", path: "/hrms/expenses/reimbursement" },
