...
import EmpDeleteEmployee from '../EmployeeViewDetails/EmpDeleteEmployee';
    ...
    <div className="flex flex-col gap-1.5 w-full relative">
        ...
        <div className="relative">
            <input
                ...
                value={value}
                onChange={onChange}
                className="w-full px-4 py-3 bg-white border border-[#D9D9D9] rounded-lg text-black text-base focus:outline-none focus:border-purple-500 transition-all"
                style={{ fontFamily: '"Inter", sans-serif' }}
            />
        </div>
    </div>
