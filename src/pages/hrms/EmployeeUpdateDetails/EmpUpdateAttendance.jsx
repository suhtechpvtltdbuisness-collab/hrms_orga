          ...
          <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4 mb-6 sm:mb-8">
              {overview.map((item, index) => (
                ...
                >
                  <p className="text-[11px] sm:text-[12px] text-gray-600 text-center mb-1">{item.label}</p>
                  <p 
                    className="text-[18px] sm:text-[20px] mt-1 sm:mt-2 text-center" 
                    style={{ fontWeight: 600, lineHeight: '100%', letterSpacing: '0%', color: '#000000' }}
                  >
                    {item.value}
                  </p>
                </div>
          ...
          <table className="w-full text-xs sm:text-sm min-w-[700px]">
            <thead className="bg-white">
              <tr className="border-b border-gray-200">
                <th className="p-2 sm:p-3 text-left text-gray-400 font-semibold whitespace-nowrap">Sr no</th>
                <th className="p-2 sm:p-3 text-left text-gray-400 font-semibold whitespace-nowrap">Date</th>
                <th className="p-2 sm:p-3 text-left text-gray-400 font-semibold whitespace-nowrap">Status</th>
                <th className="p-2 sm:p-3 text-left text-gray-400 font-semibold whitespace-nowrap">In Time</th>
                <th className="p-2 sm:p-3 text-left text-gray-400 font-semibold whitespace-nowrap">Out Time</th>
                <th className="p-2 sm:p-3 text-left text-gray-400 font-semibold whitespace-nowrap">Total Hours</th>
                <th className="p-2 sm:p-3 text-left text-gray-400 font-semibold whitespace-nowrap">Remarks</th>
              </tr>
            </thead>
