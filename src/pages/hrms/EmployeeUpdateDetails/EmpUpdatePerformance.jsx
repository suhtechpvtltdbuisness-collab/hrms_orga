...
/* Editable Input Field with Calendar */
  ...
  <div>
    ...
    <div className="relative">
      ...
      <Calendar 
        ...
        stroke="#B3B3B3"
        strokeWidth="1.6"
        style={{ top: 'calc(50% - 6.665px + 1.33px)', left: 'calc(100% - 12px - 16px + 2px)' }}
      />
      <style jsx>{`
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="border-b border-[#E0E0E0] text-[#757575]">
              ...
              <th className="px-4 py-3 text-left" style={{ fontFamily: '"Nunito Sans", sans-serif', fontWeight: 600, fontSize: '15px', lineHeight: '100%', letterSpacing: '0%' }}>Goal</th>
              <th className="px-4 py-3 text-left" style={{ fontFamily: '"Nunito Sans", sans-serif', fontWeight: 600, fontSize: '15px', lineHeight: '100%', letterSpacing: '0%' }}>Progress</th>
              <th className="px-4 py-3 text-left" style={{ fontFamily: '"Nunito Sans", sans-serif', fontWeight: 600, fontSize: '15px', lineHeight: '100%', letterSpacing: '0%' }}>Status</th>
            </tr>
          </thead>
