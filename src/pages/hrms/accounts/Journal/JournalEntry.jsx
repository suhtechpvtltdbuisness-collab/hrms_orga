  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center mb-4 shrink-0">
        ...
        >
          <span
            className="text-[16px] font-normal text-white flex items-center gap-1"
      ...
      <div className="flex-1 overflow-y-auto pr-2 space-y-4">
        {state.entries.length === 0 ? (
          <div className="border border-[#E0E0E0] rounded-lg p-4 bg-white">
            <h3
              className="text-base font-medium text-[#1E1E1E] mb-2"
              style={{ fontFamily: '"Nunito Sans", sans-serif' }}
            >
              Journal Entry
            </h3>
          ...
          state.entries.map((entry) => (
            <div
              key={entry.id}
              className="border border-[#C9C9C9] rounded-xl p-4 bg-white"
            >
              <div className="flex justify-between items-start mb-2">
                <div>
                  <h3
                    className="text-[18px] font-semibold text-[#1E1E1E] mb-1"
                    style={{ fontFamily: '"Nunito Sans", sans-serif' }}
                  >
                    {entry.remarks}
                  </h3>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    style={{ fontFamily: "Poppins, sans-serif" }}
                    onClick={() =>
                      navigate(`/hrms/journal-entry/edit/${entry.id}`)
                    }
                  >
                    Edit{" "}
                    <img
              ...
              <div className="border border-[#C9C9C9] rounded-lg overflow-hidden">
                <div
                  className="grid grid-cols-[1fr_1fr_1fr] bg-[#FFFFFF] border-b border-[#C9C9C9] p-3 text-[14px] font-normal text-[#757575]"
                  style={{ fontFamily: "Poppins, sans-serif" }}
                >
                  <div>Account</div>
                ...
                <div className="divide-y divide-[#E0E0E0]">
                  {entry.entries.map((line, idx) => (
                    <div
                      key={idx}
                      className="grid grid-cols-[1fr_1fr_1fr] p-3 text-[14px] text-[#1E1E1E]"
                    >
