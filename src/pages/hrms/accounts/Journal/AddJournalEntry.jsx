    ...
    >
      ...
      >
        ...
        <span className="text-[#6B7280]">
          {id ? "Edit Journal Entry" : "Add New Journal Entry"}
        </span>
      </div>
      ...
      <div className="flex-1 overflow-y-auto pr-2">
        <div className="border border-[#C9C9C9] rounded-xl p-4">
          <h2
            ...
            style={{ fontFamily: '"Nunito Sans", sans-serif' }}
          >
            {id ? "Edit Journal Entry" : "Create Journal Entry"}
          </h2>
            ...
            <div className="space-y-4">
              {formData.entries.length > 0 && (
                <div className="grid grid-cols-[1fr_1fr_1fr_auto] gap-4 mb-2 items-center">
                  <div className="text-[16px] font-normal text-[#1E1E1E]">
                    Account
                  </div>
                  <div className="text-[16px] font-normal text-[#1E1E1E]">
                    Debit
                ...
                >
                  <div>
                    <FilterDropdown
                      ...
                      value={entry.account}
                      onChange={(val) =>
                        handleLineChange(index, "account", val)
                      }
                  ...
                  <div className="mt-px">
                    <button
                      ...
                      className="h-10.5 px-3 border border-[#D9D9D9] rounded-lg text-[#1F1F1F] flex items-center justify-center hover:bg-red-50 hover:border-red-200 hover:text-red-500 transition-colors"
                    >
                      <X size={20} />
                    </button>
                  </div>
