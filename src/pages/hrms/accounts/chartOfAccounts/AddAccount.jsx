...
const AddAccount = () => {
    ...
    const handleSave = () => {
        ...
        const existingAccounts = JSON.parse(localStorage.getItem('hrms_accounts')) || [];
    ...
    return (
        <div className="bg-white px-4 sm:px-4 md:px-6 py-6 mx-2 sm:mx-4 mt-4 mb-4 rounded-xl h-[calc(100vh-10rem)] flex flex-col font-inter" style={{ fontFamily: 'Inter, sans-serif' }}>
            ...
            <div className="flex justify-between items-center mb-6 shrink-0">
                <h1 className="text-[20px] font-semibold text-[#494949]" style={{ fontFamily: '"Nunito Sans", sans-serif' }}>{editingAccount ? formData.accountName : 'Add Account'}</h1>
            ...
            <div className="flex-1 overflow-y-auto pr-2">
                <div className="border border-[#C9C9C9] rounded-xl p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                        {/* Account Name */}
                        <div>
                            <label className="block text-[16px] font-normal text-[#1E1E1E] mb-2">Account Name</label>
                            <input 
                                type="text"
                                name="accountName"
                        ...
                        <div>
                         ...
                         {/* Parent Account */}
                         <div>
                            <label className="block text-[16px] font-normal text-[#1E1E1E] mb-2">Parent Account</label>
                            <input 
                                type="text"
                                name="parentAccount"
                         ...
                         {/* Currency */}
                         <div>
                            <label className="block text-[16px] font-normal text-[#1E1E1E] mb-2">Currency</label>
                            <input 
                                type="text"
                                name="currency"
                    ...
                    {location.state?.viewMode ? (
                        <div className="flex items-center gap-4 mt-4">
                            ...
                            <button
                                className="px-3 py-2 bg-[#7D1EDB] rounded-full text-white font-medium text-[16px] hover:bg-purple-700 transition-colors"
                                style={{ fontFamily: 'Poppins, sans-serif' }}
                                onClick={() => navigate('/hrms/chart-of-accounts/ledger', { state: { account: formData } })}
                            >
                                View Ledger
                            </button>
                        </div>
