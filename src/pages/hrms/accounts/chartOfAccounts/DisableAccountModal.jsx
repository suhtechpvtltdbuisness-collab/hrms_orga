...
const DisableAccountModal = ({ isOpen, onClose, onConfirm, accountName }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#00000040]">
      <div className="bg-white rounded-2xl w-130 shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200 relative">
        <button
          onClick={onClose}
        ...
        <div className="p-4">
          <div className="flex gap-3">
            ...
            <div className="flex-1" style={{ fontFamily: "Inter, sans-serif" }}>
              ...
              <p className="text-[14px] text-[#15192080] mb-4 font-normal leading-relaxed">
                This account has existing transactions that must be resolved
          ...
          {/* Details Box */}
          <div
            className="bg-[#F1F1F1] rounded-lg p-3 mb-4 w-[95%] mx-auto"
          ...
          >
            ...
            <p className="text-[16px] text-[#15192080]">
              Please clear all transactions linked to this account before
              disabling it.
            </p>
          </div>
