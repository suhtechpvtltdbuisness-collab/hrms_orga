    ...
    <Router>
      ...
      <Layout>
        <Routes>
          ...
          />
          <Route
            path="/hrms/onboarded-employee-list/team-list"
            element={<TeamList />}
          />
          ...
          />
          <Route
            path="/hrms/upload-attendance"
            element={<UploadAttendance />}
          />
          <Route
            path="/hrms/request-attendance"
          ...
          <Route
            path="/hrms/salary-structure-assignment"
          ...
          <Route
            path="/hrms/appraisal-template"
            element={<AppraisalTemplate />}
          />
          <Route
            path="/hrms/appraisal-template/new"
            element={<NewAppraisalTemplate />}
          />
          <Route path="/hrms/appraisal/new" element={<NewAppraisal />} />
          <Route
            path="/hrms/energy-point-log"
            element={<EnergyPointLogList />}
          />
          <Route path="/hrms/energy-point-rule" element={<EnergyPointRule />} />
          <Route
            path="/hrms/energy-point-rule/new"
            element={<NewEnergyPointRule />}
          />
          <Route
            path="/hrms/energy-point-setting"
            element={<EnergyPointSettings />}
          />
          <Route
            path="/hrms/additional-salary"
            element={<AdditionalSalary />}
          />
          <Route
            path="/hrms/payroll-accounting"
            element={<PayrollAccounting />}
          />
          ...
          <Route
            path="/hrms/chart-of-accounts/ledger"
          ...
          <Route
            path="/hrms/journal-entry/edit/:id"
          ...
          <Route
            path="/hrms/expenses/category/new"
            element={<AddExpenseCategory />}
          />
          <Route
            path="/hrms/expenses/category/:id"
            element={<AddExpenseCategory />}
          />
          <Route
            path="/hrms/expenses/reimbursement"
            element={<ReimbursementCycle />}
          />
          <Route 
            path="/hrms/expenses/pending-approvals" 
          ...
          <Route
            path="/hrms/sales-invoice/view/:id"
            element={<AddSalesInvoice />}
          />
          <Route
            path="/hrms/sales-invoice/edit/:id"
            element={<AddSalesInvoice />}
          />
          ...
          <Route
            path="/hrms/purchase-invoice/new"
            element={<AddPurchaseInvoice />}
          />
          <Route
            path="/hrms/purchase-invoice/view/:id"
            element={<AddPurchaseInvoice />}
          />
          <Route
            path="/hrms/purchase-invoice/edit/:id"
            element={<AddPurchaseInvoice />}
          />

          {/* Recurring Invoices */}
          <Route
            path="/hrms/recurring-invoice"
            element={<RecurringInvoice />}
          />
          <Route
            path="/hrms/recurring-invoice/new"
            element={<AddRecurringInvoice />}
          />
          <Route
            path="/hrms/recurring-invoice/view/:id"
            element={<AddRecurringInvoice />}
          />
          <Route
            path="/hrms/recurring-invoice/edit/:id"
            element={<AddRecurringInvoice />}
          />

          {/* Invoice Payment Allocation */}
          <Route
            path="/hrms/invoice-payment-allocation"
            element={<InvoicePaymentAllocation />}
          />
          <Route
            path="/hrms/invoice-payment-allocation/new"
            element={<RecordPayment />}
          />
          <Route
            path="/hrms/invoice-payment-allocation/view/:id"
            element={<RecordPayment />}
          />
          <Route
            path="/hrms/invoice-payment-allocation/edit/:id"
            element={<RecordPayment />}
          />
        </Routes>
      </Layout>
